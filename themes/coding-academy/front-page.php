        ...
        <div class="full-width-split__inner">
          ...
          <?php
            ...
            while($events->have_posts()) {
                $events->the_post(); 
                get_template_part('template-parts/content', 'event'); // This will look for the template, 'content-event'
          ?>
          <?php
            } wp_reset_postdata();
          ?>
        ...
        <?php 
            ...
            while($posts->have_posts()) {
                ...
                <div class="event-summary">
                    <a class="event-summary__date event-summary__date--lightGray t-center" href="<?php the_permalink(); ?>">
